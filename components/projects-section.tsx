...
const projects = [
  {
    ...
    description:
      "Modern ve interaktif kişisel portföy sitesi. Uzay temalı 3D animasyonlar, responsive tasarım ve etkileyici kullanıcı deneyimi ile geliştirildi.",
    image: "/dark-portfolio-website-with-purple-neon-accents-cy.jpg",
    tags: ["Next.js", "Tailwind CSS", "Framer Motion", "TypeScript"],
    gradient: "from-purple-600 to-pink-600",
    link: "#",
    icon: Code2,
    features: ["Responsive Tasarım", "Dark Tema", "3D Animasyonlar"],
  },
  {
    title: "E-Ticaret Dashboard",
    description:
      "Kapsamlı bir e-ticaret yönetim paneli. Satış analitiği, envanter yönetimi, sipariş takibi ve gerçek zamanlı raporlama özellikleri ile donatılmıştır.",
    image: "/ecommerce-dashboard-dark-theme.jpg",
    tags: ["React", "Node.js", "PostgreSQL", "REST API"],
    gradient: "from-cyan-600 to-blue-600",
    link: "#",
    icon: Shield,
    features: ["Analitik Panel", "Envanter Yönetimi", "Gerçek Zamanlı"],
  },
  {
    title: "AI Sohbet Uygulaması",
    description:
      "Yapay zeka destekli sohbet uygulaması. Doğal dil işleme, bağlam anlama ve akıllı yanıt oluşturma özellikleri ile geliştirilmiş modern bir chat deneyimi.",
    image: "/ai-chat-application-dark-theme.jpg",
    tags: ["Next.js", "OpenAI API", "Tailwind", "Prisma"],
    gradient: "from-emerald-600 to-teal-600",
    link: "#",
    icon: Globe,
    features: ["AI Entegrasyonu", "Gerçek Zamanlı", "Modern Arayüz"],
  },
]
        ...
        <ScrollReveal direction="up">
          <div className="text-center mb-20">
            <div className="inline-flex items-center gap-2 glass px-4 py-2 rounded-full mb-6 animate-pulse-glow">
              ...
              <span className="text-sm text-cyan-300 font-mono">Projelerim</span>
            </div>
            <h2 className="text-4xl md:text-6xl font-bold mb-6">
              <span className="text-white">Öne Çıkan </span>
              <span className="text-gradient-animated">Projeler</span>
            </h2>
            <p className="text-gray-400 max-w-2xl mx-auto text-lg leading-relaxed">
              Web geliştirme, yapay zeka ve modern teknolojiler alanında geliştirdiğim projeler
            </p>
          </div>
        </ScrollReveal>
